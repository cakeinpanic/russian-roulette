...
Object.defineProperty(exports, "__esModule", { value: true });
exports.sendToRandomFixer = exports.sendToSlack = void 0;
const core_1 = __webpack_require__(470);
const web_api_1 = __webpack_require__(114);
const dotenv_1 = __importDefault(__webpack_require__(63));
dotenv_1.default.config();
const token = process.env.SLACK_TOKEN || core_1.getInput('slack-token', { required: true });
const channelId = process.env.CHANNEL_ID || core_1.getInput('slack-channel', { required: true });
const web = new web_api_1.WebClient(token);
const sendToSlack = (phrase) => __awaiter(void 0, void 0, void 0, function* () {
    const res = yield web.chat.postMessage({
        channel: channelId,
        blocks: [
            {
                'type': 'section',
...
const fixersList = (process.env.FIXERS || core_1.getInput('fixers', { required: true })).split(',');
const sendToRandomFixer = (message) => {
    const fixer = random_item_1.default(fixersList);
    exports.sendToSlack(`Lucky one is <@${fixer}>! You are honoured to fix this one:\n \`\`\`${message}\`\`\``);
};
exports.sendToRandomFixer = sendToRandomFixer;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return stripAnsi; });
...
const strip_ansi_1 = __importDefault(__webpack_require__(188));
const slack_1 = __webpack_require__(75);
function extractFailedTestsMessages(filePath = './jest.json') {
    const metadata = JSON.parse(fs_1.default.readFileSync(filePath).toString());
...
extractFailedTestsMessages().forEach(slack_1.sendToRandomFixer);
